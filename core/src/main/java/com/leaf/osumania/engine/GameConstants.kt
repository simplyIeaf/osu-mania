...
object GameConstants {
    ...
    const val JUDGEMENT_IDOL = 320
    const val JUDGEMENT_PERFECT = 300
    const val JUDGEMENT_GREAT = 200
    const val JUDGEMENT_GOOD = 100
    const val JUDGEMENT_BAD = 50
    const val JUDGEMENT_MISS = 0

    const val MISS_WINDOW = 173f
    const val IDOL_WINDOW = 19.4f
